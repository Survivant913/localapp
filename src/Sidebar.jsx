  ...
  return (
    <>
      ...
      `}>
        ...
        {/* --- TECHNIQUE DU MASQUE CSS (POCHOIR) - ZOOM PROPORTIONNEL --- */}
        <div 
        ...
        >
            <div 
                ...
                style={{
                    ...
                    // --- MODIFICATION CLÉ ICI POUR LA QUALITÉ ---
                    // Largeur = 180% du conteneur (très large)
                    // Hauteur = auto (garde les proportions exactes, pas de déformation)
                    maskSize: '180% auto', 
