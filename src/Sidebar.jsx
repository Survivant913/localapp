  ...
  return (
    <>
      ...
      `}>
        ...
        {/* Correction : Prend tout l'espace (inset-0), centré, et bien visible (opacity-10/15) */}
        <div className="absolute inset-0 pointer-events-none opacity-10 z-0 flex items-center justify-center overflow-hidden">
            <svg 
                viewBox="0 0 500 500" 
                className={`text-blue-600 fill-current transition-transform duration-700 ${isCollapsed ? 'scale-[3] rotate-0' : 'scale-[1.8] -rotate-12'}`}
            >
                {/* Dessin Tribal Dragon Agressif */}
                <path d="M150 200 C 120 180, 100 150, 130 120 C 160 90, 200 100, 220 130 C 240 150, 230 180, 200 200 Z M 300 300 C 350 320, 380 300, 360 250 C 340 220, 300 210, 280 240 C 260 270, 280 290, 300 300 M 100 400 C 80 350, 120 320, 150 340 C 180 360, 190 400, 160 430 C 130 450, 110 420, 100 400 M 400 100 C 420 80, 450 120, 430 150 C 410 180, 380 160, 360 140 C 340 120, 380 110, 400 100 M 250 250 Q 150 50 50 150 Q 100 250 200 300 Q 300 400 450 350 Q 400 250 300 150 Q 200 50 100 100" />
                <path d="M 250 250 L 350 150 L 400 200 L 300 300 Z M 150 350 L 200 400 L 250 350 L 200 300 Z M 100 100 L 150 50 L 200 100 L 150 150 Z" />
                <path d="M 50 250 C 20 250, 10 200, 40 180 C 70 160, 100 180, 110 210 C 120 240, 90 260, 50 250 M 450 250 C 480 250, 490 300, 460 320 C 430 340, 400 320, 390 290 C 380 260, 410 240, 450 250" />
            </svg>
        </div>
