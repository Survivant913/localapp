    ...
    return (
        ...
        <div className="space-y-8 fade-in p-6 pb-24 md:pb-20 w-full transition-all duration-500 bg-slate-50/10 dark:bg-slate-950/20">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-1 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-white dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 relative overflow-hidden group">
                    ...
                    {/* --- 2. TEXTE CENTRALISÉ : TABLEAU DE BORD + DATE SEULEMENT --- */}
                    <div className="relative z-10 text-center flex-1">
                        <h2 className="text-3xl md:text-5xl font-black text-slate-800 dark:text-white mb-2 tracking-tighter italic">
                            Tableau de Bord
                        </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                {/* --- 3. PROJETS ACTIFS (TITRE CORRIGÉ) --- */}
