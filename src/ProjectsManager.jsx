...
export default function ProjectsManager({ data, updateData }) {
    ...
    // États d'interface
    const [showForm, setShowForm] = useState(false); // NOUVEAU : Pour cacher/montrer le formulaire
    ...
    const startEditProject = (project) => { 
        ...
        setLinkedAccountId(project.linkedAccountId || ''); 
        setShowForm(true); // On force l'ouverture
        ...
        <div className="space-y-8 fade-in max-w-4xl mx-auto pb-20">
            ...
            <div className="space-y-6">
                ...
                {sortedProjects.map(project => {
                    ...
                    const linkedAccountName = project.linkedAccountId ? accounts.find(a => a.id === project.linkedAccountId)?.name : null;
